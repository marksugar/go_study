...
func main() {
	...
	*/
	...
	fmt.Println("\033[1;31mHOME:\033[0m",HOME, "\t\033[1;31mUSER:\033[0m",USER, "\t\033[1;31mGOROOT:\033[0m",GOROOT)
	...
	*/
	...
	fmt.Printf("\033[1;31mThe operating system is:\033[0m %s\n", goos)
	path := os.Getenv("PATH")
	fmt.Printf("\033[1;31mPath is:\033[0m %s\n", path)
